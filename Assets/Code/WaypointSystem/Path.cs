...
namespace TAMKShooter.WaypointSystem
{
    public class Path : MonoBehaviour
    {
                ...
                if(Waypoints[i] == currentWaypoint)
                {
                    switch (_pathType)
                    {
                        ...
                        case PathType.Patrol:
                            nextWaypoint = GetNextWaypointPatrol(i, ref direction);
                            break;
                    }
                }
            }
        ...
        private Waypoint GetNextWaypointPatrol(int currentWaypointIndex, ref Direction direction)
        {
            Waypoint nextWaypoint = null;
